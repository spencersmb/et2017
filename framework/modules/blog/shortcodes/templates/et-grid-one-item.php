...
<div class="flex-xs flex-sm-4">
    <div class="et-grid-one__item">
        ...
        <a href="<?php echo esc_url(get_page_link($page_link)); ?>"><?php echo wp_kses($link_text, $allowed_html, 'et-twenty-seventeen'); ?><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
    </div>
</div>
