...
var project = 'sprout', // Project name, used for build zip.
	url = 'http://www.everytuesday.dev/', // Local Development URL for BrowserSync. Change as-needed.
...
gulp.task('clean-ts', function(cb) {
	var typeScriptGenFiles = [
		'./assets/js/custom' + '/**/*.js', // path to all JS files auto gen'd by editor
		'./assets/js/custom' + '/**/*.js.map', // path to all sourcemap files auto gen'd by editor
		'!' + './assets/js/custom' + '/lib'
	];
