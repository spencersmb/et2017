...
add_action( 'widgets_init', 'et_twenty_seventeen_about_load_widget' );

function et_twenty_seventeen_about_load_widget() {
	register_widget( 'et_twenty_seventeen_about_widget' );
}

class et_twenty_seventeen_about_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	public function __construct() {
		$this->textdomain = 'et_twenty_seventeen_about_widget';
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'et_twenty_seventeen_about_widget',
			'description' => esc_html__('A widget that displays an About widget', 'et_twenty_seventeen_about_widget')
		);

		/* Widget control settings. */
		$control_ops = array(
			'width' => 250, 'height' => 350,
			'id_base' => 'et_twenty_seventeen_about_widget'
		);
